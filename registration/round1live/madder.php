...
else
{
  if(isset($_POST["next"]))
  {
    ...
    $sql="select answer from answers_round1 where id=4";
    ...
    {
      session_start();
      $sql="update participants_round1 set currques=5, logintime = CURRENT_TIMESTAMP() where uname = '".$_SESSION['user']."'";
...
?>
 ...
 <!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <link  rel="stylesheet" href="styler1q4.css" type="text/css">-->
...
<div class="wrapper row" style="padding-top: 1%;">
  <div class="font-area">
    ...
    <h1>I CONSIST OF ONLY ALPHABETS </h1>
    <h1>AND DIGITS.........</h1><br>
    <h1>"ARE YOU THE ONE TO SEE"</h1>
  </div>
</div>
