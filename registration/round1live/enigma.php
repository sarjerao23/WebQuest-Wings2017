  ...
  if(isset($_POST["next"]))
  {
    ...
    $sql="select answer from answers_round1 where id=3";
    ...
    {
      session_start();
      $sql="update participants_round1 set currques=4, logintime = CURRENT_TIMESTAMP() where uname = '".$_SESSION['user']."'";
...
<link rel="stylesheet" type="text/css" href="styler1q3.css">-->
...
/*stylerq3r1*/
html{
  background: url('images/machinefinal.jpg')no-repeat center center fixed ;
