 ...
 //connection
    ...
    //{
      ...
      //$sql="update participants_round1 set currques=2 where user='".$_SESSION['user']."'";
			$sql="update participants_round2 set currques=5, logintime = CURRENT_TIMESTAMP() where uname = '".$_SESSION['user']."'";

			$result=$conn->query($sql);
			if($result)
      {   //echo "<script>alert('Right answer');</script>";  
  header('location:revealations.php');
	...
	<center>
		<div style="padding-top: 15%;">
			<h3 style="text-align:center; color: black; font-size: 36px;">
				"And I looked, and behold, a pale horse!<br>And its rider’s name was <b>Death</b>, and Hades followed him. <br>And they were given authority over a fourth of the earth, <br>to kill with sword and with famine and with pestilence <br>and by wild beasts of the earth."<br><br>
			</h3>
		</div>	
		<div>
			<form method="POST" action="">
				<center>
					<input type="submit" name="next" id="next" class="next" value="THE END">
				</center>
			</form>
		</div>
	</center> 
